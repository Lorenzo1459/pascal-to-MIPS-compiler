...
char* kind2str(NodeKind kind) {
    switch(kind) {
        ...
        case MOREQ_NODE:    return ">=";
        case MT_NODE:       return ">";
        case LOREQ_NODE:    return ">=";
        case NOTEQ_NODE:    return "<>";
        case OR_NODE:       return "or";
        case MOD_NODE:      return "mod";
        case DIV_NODE:      return "div";
        ...
        case TYPE_LIST_NODE:  return "type_list";
        case BLOCK_HEAD_NODE: return "head_block";
        case PROC_FUNC_LIST_NODE: return "proc_func_list";
